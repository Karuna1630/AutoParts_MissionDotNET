          ...
          >
            {({ isSubmitting, resetForm, status }) => (
              <Form className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                {status?.message && (
                  <div
                    className={`md:col-span-2 p-4 rounded-xl text-sm font-bold ${status.type === "success" ? "bg-emerald-50 text-emerald-600 border border-emerald-100" : "bg-red-50 text-red-600 border border-red-100"}`}
                  >
                    {status.message}
                  </div>
                )}
